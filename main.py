...
from implementation.publish_subscribe.sound_subscriber import SoundSubscriber # וודא שהנתיב נכון
...
def main():
    ...
    try:
        ...
        # event_manager.subscribe(EventType.ILLEGAL_MOVE, sound_subscriber.on_illegal_move)
